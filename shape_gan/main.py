...
from model import au2shape
import tensorflow as tf

parser = argparse.ArgumentParser(description='')
parser.add_argument('--dataset_name', dest='dataset_name', default='shapes', help='name of the dataset')
parser.add_argument('--epoch', dest='epoch', type=int, default=200, help='# of epoch')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=64, help='# smaples in batch')
...
parser.add_argument('--layer_features', dest='layer_features', type=bool, default=False, help='if layer_features is true, use the layer_features in loss function')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = au2shape(sess, batch_size=args.batch_size,dataset_name=args.dataset_name, layer_features=args.layer_features,
